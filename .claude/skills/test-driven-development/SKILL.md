...
**Bad tests** are coupled to implementation. They mock internal collaborators, test private methods, or verify through external means. Warning sign: test breaks when refactoring, but behavior hasn't changed.
...
- You end up testing the _shape_ of things, not user-facing behavior
